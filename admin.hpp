...
void Admin::addCourt()
{
    ...
    {
    case 1:
        newCourt = new Badminton(courtNumber);
        break;
    case 2:
        newCourt = new Basketball(courtNumber);
        break;
    case 3:
        newCourt = new Volleyball(courtNumber);
        break;
    case 4:
        newCourt = new Football(courtNumber);
        break;
    case 5:
        newCourt = new Cricket(courtNumber);
        break;
    }
